        ...
        <div className={`${style.me} ${style.card}`}>
          <div>
            <p className={style.paragraph}>
              ...
              different kind of systems since I started working 18 years ago, I
              love to solve problems and think out of the box to find issues
              where is hard to find them.
            </p>
            <p className={style.paragraph}>
              My curiosity is what pushes me to learn and keeps me motivated to
              continue in the learning loop. I started learning web development
              6 years ago self tough been curious in how was the life cycle of a
              web page.
            </p>
            <p className={style.paragraph}>
              <Link href='/portfolio'>
            ...
            <p className={style.paragraph}>
              ...
              what I want to do, it is what wakes me up early in the morning to
              keep learning.
            </p>
            <p className={style.paragraph}>
            ...
            <p className={style.paragraph}>
              I love to create responsive and functional websites that are easy
              to use and make sense for everyone.
            </p>
          </div>
        </div>
      </section>
